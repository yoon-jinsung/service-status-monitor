...
팀이 의존하는 외부 SaaS 서비스(GitHub, Notion, Vercel, Slack)의 장애 및 상태 변화를 **자동으로 감지**하여 **Slack 채널에 실시간 알림**을 전달하는 모니터링 서비스입니다.
...
| Notion | status.notion.so | Atlassian Statuspage |
| Vercel | vercel-status.com | Atlassian Statuspage |
...
| Name | Value |
|------|-------|
| `SLACK_STATUS_WEBHOOK_URL` | Slack에서 복사한 Webhook URL |
